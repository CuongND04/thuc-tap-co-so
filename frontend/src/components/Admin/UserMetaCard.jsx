...
const UserMetaCard = ({ userProfile }) => {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      // Gọi hàm updateProfile từ store (giả sử bạn dùng hook useAuthStore)
      const updatedProfile = await updateProfile(values);

      if (updatedProfile) {
        // Nếu cập nhật thành công, bạn có thể làm thêm việc gì đó, ví dụ reset form hoặc thông báo
        console.log("Cập nhật profile thành công:", updatedProfile);
      } else {
        // Nếu cập nhật thất bại
        console.error("Cập nhật profile thất bại");
      }
    } catch (error) {
      console.error("Validation failed or error occurred:", error);
    }
  };
  ...
  const initialValues = {
    ...
    tenDangNhap: userProfile?.tenDangNhap,
  };
  return (
    <div>
      <div>
        <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
          <div className="flex flex-col gap-2 xl:flex-row xl:items-center xl:justify-between">
            <div className="flex flex-col items-center flex-2/5 gap-6 xl:flex-row">
              ...
              <div className="flex items-center order-2 gap-2 grow xl:order-3 xl:justify-end">
                <a
                  href="https://www.facebook.com/BatHuPTIT"
                  target="_blank"
                  rel="noopener"
          ...
          <div className="no-scrollbar relative w-full overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
            <div className="px-2 pr-14">
              ...
              <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
                Cập nhật thông tin của bạn để giữ hồ sơ luôn chính xác và mới
                nhất.
              </p>
            </div>
                    ...
                    >
                      <div className="flex items-center gap-4">
                        {form.getFieldValue("avatar") && (
                          // nó sẽ hiển thị preview khi người dùng up ảnh mà chưa ấn lưu
                          <img
