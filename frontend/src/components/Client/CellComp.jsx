      ...
      <div className="group/a1">
        <div className="">
          <div className="relative overflow-hidden group">
            <a href={`/san-pham/${prodID}`}>
              {newStat && (
                <div className="absolute top-[10px] right-[10px] h-[40px] w-[40px] flex justify-center items-center bg-[#8bc34a] rounded-[50%] group-hover:hidden">
                  <p className="w-[35px] h-[35px] flex justify-center items-center border-[1px] border-dotted border-white text-white font-[Dosis] rounded-[50%]">
                    New
                  </p>
                </div>
              )}
              ...
              <a href={`/san-pham/${prodID}`}>
                <div className="mt-0 mb-0 mr-[10px] ml-[10px] bg-[#de8ebe] w-[40px] h-[40px] text-white text-[18px] inline-flex justify-center items-center rounded-[100px]  hover:bg-white group/b1">
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="bg-transparent w-[70%] h-[70%] text-white text-[18px] font-bold inline-flex justify-center items-center hover:text-[#de8ebe] group-hover/b1:text-[#de8ebe]"
                  >
                    <path
                      fillRule="evenodd"
            ...
            <div className="absolute hidden bottom-[90px] left-[50%] bg-[#de8ebe] rounded-[10px] transform -translate-x-[50%] group-hover:block hover:bg-[#cf72aa]">
              <div className="flex justify-center items-center w-[140px] h-[40px] rounded-[10px]">
                <button
                  onClick={addToCart}
                  class="flex justify-center items-center bg-[#de8ebe] w-[130px] h-[35px] rounded-[10px] border-[1px] border-dashed border-[#fff] hover:bg-[#cf72aa] cursor-pointer"
                  id="useFunctionBtn"
                >
                  <span className="text-white text-[14px] font-bold after:content-['\276F']after:m-[10px] after:font-[400]">
                    Thêm vào giỏ
                  </span>
                </button>
              </div>
        ...
        <div className="">
          <div className="relative mt-[15px] mb-[15px] ml-0 mr-0 flex justify-between">
            <span className="font-bold text-[#de8ebe] text-[12px]">
              ID:{prodID}
            </span>
