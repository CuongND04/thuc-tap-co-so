                    ...
                    <div className="">
                      <div className="relative overflow-hidden group">
                        ...
                        <div className="absolute hidden top-[35%] left-[27%] group-hover:block">
                          <a href="">
                            <i className="mt-0 mb-0 mr-[10px] ml-[10px] bg-[#de8ebe] w-[40px] h-[40px] text-white text-[18px] inline-flex justify-center items-center rounded-[100px] fa-regular fa-heart hover:text-[#de8ebe] hover:bg-white group/b1">
                        ...
                        <div className="absolute hidden bottom-[90px] left-[50%] bg-[#de8ebe] rounded-[10px] transform -translate-x-[50%] group-hover:block hover:bg-[#cf72aa]">
                          <div className="flex justify-center items-center w-[140px] h-[40px] rounded-[10px]">
                            <button class="flex justify-center items-center bg-[#de8ebe] w-[130px] h-[35px] rounded-[10px] border-[1px] border-dashed border-[#fff] hover:bg-[#cf72aa]" id="useFunctionBtn">
                              <span className="text-white text-[14px] font-bold after:content-['\276F']
  after:m-[10px] after:font-[400]">Thêm vào giỏ</span>
                            </button>
                          </div>
                        </div>
                      </div>
