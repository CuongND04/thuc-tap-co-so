...
const Registeration = () => {
    ...
    return (
        <div>
            ...
            <div>
                <h1 className="block text-center font-bold text-3xl pt-6">Đăng ký</h1>
                <p className="text-xl text-center pt-5 leading-3">Đăng ký để mua sắm với chúng tôi ngay hôm nay!</p>
            </div>
            ...
            <div>
                <div className="mt-5 grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
                    <div> 
                        ...
                        <input type="text" name="fullName" className="block w-full rounded-md border-0 bg-black/10 py-1 ring-1 outline-none ring-inset focus:ring-2 focus:ring-[#de8ebe] px-3 mt-1 text-lg" />
                    </div>
                    ...
                    <div> 
                        ...
                        <input type="email" name="email" className="block w-full rounded-md border-0 bg-black/10 py-1 ring-1 outline-none ring-inset focus:ring-2 focus:ring-[#de8ebe] px-3 mt-1 text-lg" />
                    </div>

                    <div> 
                        <LabelComp title="Số điện thoại" htmlFor="phoneNumber"/>
                        <input type="text" name="phoneNumber" className="block w-full rounded-md border-0 bg-black/10 py-1 ring-1 outline-none ring-inset focus:ring-2 focus:ring-[#de8ebe] px-3 mt-1 text-lg" />
                    </div>

                    <div> 
                        <LabelComp title="Địa chỉ" htmlFor="address"/>
                        <input type="text" name="address" className="block w-full rounded-md border-0 bg-black/10 py-1 ring-1 outline-none ring-inset focus:ring-2 focus:ring-[#de8ebe] px-3 mt-1 text-lg" />
                    </div>
                </div>
