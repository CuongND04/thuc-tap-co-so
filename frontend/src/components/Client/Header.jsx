    ...
    <div>
      <header className="flex justify-center">
        ...
        <nav className="mt-5 h-10 w-full flex justify-center">
          ...
          <PopoverGroup className="hidden lg:flex lg:gap-x-12">
            <a href="/" className="block relative w-30 h-8 font-semibold bg-[#de8ebe] text-white uppercase text-lg text-center place-content-center tracking-wide rounded-md hover:text-white hover:bg-[#de8ebe]/87 duration-200" >Trang chủ</a>
                ...
                {menu1.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-auto">
                      <a href={`/danh-muc-cun/${item}`} className="block font-semibold text-gray-900">
                        {item}
          ...
          <a href="#" className="text-lg font-semibold text-gray-900 hover:text-[#de83be]">
            Phụ kiện
          </a>
          ...
          {/* Login components */}
          {isLoggingIn && <p className="text-lg font-semibold text-gray-900">Chào mừng, {userName}! <button onClick={loggingOut} className="hover:text-[#de83be]">Đăng xuất</button></p>}

          {!isLoggingIn && <p className="text-lg font-semibold text-gray-900"><a href="/dang-nhap" className="pr-1 text-lg font-semibold text-gray-900 hover:text-[#de83be]">Đăng nhập</a>/<a href="/dang-ky" className="pl-1  text-lg font-semibold text-gray-900 hover:text-[#de83be]">Đăng ký</a></p>}
        ...
        <div className="-ml-70 flex h-auto justify-center">
              <div className="-mt-23">
                <img className="w-[768px] h-[267.15px] rounded-3xl" src={images[currentIndex]} alt="Slider" />
                <div className="flex justify-between bg-transparent">
                  <button className="-ml-[30px] -mt-37 h-full cursor-pointer pointers-events-auto border-2 border-gray-900 hover:border-[#de8ebe] rounded-md" onClick={comeback}>
                    <ChevronLeftIcon className="w-5 h-5 fill-gray-900 hover:fill-[#de8ebe]"/>
                  </button>
                  <button className="-mr-[30px] -mt-37 h-full cursor-pointer pointers-events-auto border-2 border-gray-900 hover:border-[#de8ebe] rounded-md" onClick={next}>
      ...
      <form className="mt-5 ml-40">
        <div className="flex w-150 items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-black has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-[#de8ebe]">
          ...
          />
          <button type="reset" className="visible peer-placeholder-shown:invisible">X</button>
          ...
          <button type="submit" className="bg-[#de8ebe]">Tìm kiếm</button>
        </div>
      </form>
    </div>
