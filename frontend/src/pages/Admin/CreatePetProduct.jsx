...
const CreatePetProduct = () => {
  ...
  const onFinish = async (values) => {
    ...
    const data = {
      ...
      thuCung: {
        ...
        tuoi: values.tuoi + " tháng",
        trangThaiTiem: values.trangThaiTiem,
  ...
  return (
    <Card>
      <Title level={2}>Thêm sản phẩm Thú cưng</Title>
      <Form layout="vertical" form={form} onFinish={onFinish}>
        ...
        >
          <Select placeholder="Chọn danh mục">
            {categories
              .filter((cat) => cat.kieu === "thu_cung") // lọc theo kiểu "thu_cung"
              .map((cat) => (
        ...
        <Form.Item
          ...
          rules={[{ required: true, message: "Vui lòng nhập trạng thái tiêm" }]}
        >
          <Input />
        </Form.Item>
